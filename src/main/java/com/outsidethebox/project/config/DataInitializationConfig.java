	...
	public void run(String... args) throws Exception {
		...
		if (userRepository.count() == 0) {
			List<User> users = List.of(
					new User("Juan Electronica", "juan.perez@example.com", "1234567890", "123456", "/images/users/default-profile.png", true, dateFormat.parse("2023-12-10")),
					new User("María López", "maria.lopez@example.com", "1234567890", "123456", "/images/users/default-profile.png", false, dateFormat.parse("2023-12-10")),
					new User("Carlos Plomero", "carlos.garcia@example.com", "1234567890", "123456", "/images/users/default-profile.png", true, dateFormat.parse("2023-12-10")),
					new User("Ana Torres", "ana.torres@example.com", "1244567890", "123456", "/images/users/default-profile.png", false, dateFormat.parse("2023-12-31")),
					new User("Luis Martínez Carpintero", "luis.martinez@example.com", "1234567890", "123456", "/images/users/default-profile.png", true, dateFormat.parse("2023-12-10")),
					new User("Elena Gómez", "elena.gomez@example.com", "1234567890", "123456", "/images/users/default-profile.png", false, dateFormat.parse("2023-12-10")),
					new User("Miguel Mantenimiento", "miguel.santos@example.com", "1234567890", "123456", "/images/users/default-profile.png", true, dateFormat.parse("2023-12-10")),
					new User("Miranda Servicios", "miranda.servicios@example.com", "1234567890", "123456", "/images/users/default-profile.png", true, dateFormat.parse("2023-12-10"))
			);
			...
			List<Order> orders = List.of(
					 new Order(postRepository.findById(1L).get(), userRepository.findById(2L).get(), Category.Electricista, "Arreglo de TV", 999.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(2L).get(), userRepository.findById(2L).get(), Category.Gasista, "Arreglo de sistemas de gas natural", 29.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(3L).get(), userRepository.findById(2L).get(), Category.Plomero, "Reparación de tuberías", 199.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(7L).get(), userRepository.findById(4L).get(), Category.Carpintero, "Construcción de casas", 999.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(8L).get(), userRepository.findById(4L).get(), Category.Gasista, "Instalación de sistemas de gas", 299.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(9L).get(), userRepository.findById(4L).get(), Category.Jardinero, "Mantenimiento de áreas verdes", 199.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(10L).get(), userRepository.findById(4L).get(), Category.Carpintero, "Restauración de muebles", 299.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(11L).get(), userRepository.findById(4L).get(), Category.Electricista, "Instalación eléctrica", 199.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(15L).get(), userRepository.findById(6L).get(), Category.Plomero, "Instalación de sanitarios", 299.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(16L).get(), userRepository.findById(6L).get(), Category.Electricista, "Reparación de televisores", 199.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(4L).get(), userRepository.findById(2L).get(), Category.Carpintero, "Fabricación de muebles", 499.99, "1", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(5L).get(), userRepository.findById(2L).get(), Category.Jardinero, "Mantenimiento de jardines", 299.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(6L).get(), userRepository.findById(2L).get(), Category.Electricista, "Reparación de lavadoras", 399.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(17L).get(), userRepository.findById(6L).get(), Category.Jardinero, "Cuidado de plantas", 99.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(18L).get(), userRepository.findById(6L).get(), Category.Carpintero, "Reparación de tejados", 499.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(12L).get(), userRepository.findById(4L).get(), Category.Electricista, "Reparación de aire acondicionado", 599.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(13L).get(), userRepository.findById(4L).get(), Category.Jardinero, "Diseño de jardines", 499.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01")),
		             new Order(postRepository.findById(14L).get(), userRepository.findById(4L).get(), Category.Carpintero, "Talla de madera", 399.99, "0", dateFormat.parse("2024-09-01"), dateFormat.parse("2024-01-01"))
			);
	        orderRepository.saveAll(orders);
	        
	        List<Review> reviews = List.of(
	        		new Review(postRepository.findById(1L).get(), userRepository.findById(2L).get(), 5, "Excelente trabajo. La reparación de la TV fue rápida y efectiva.", dateFormat.parse("2024-01-02")),
	                new Review(postRepository.findById(2L).get(), userRepository.findById(2L).get(), 4, "Buen servicio en el arreglo de sistemas de gas natural, aunque el tiempo de respuesta fue un poco largo.", dateFormat.parse("2024-01-02")),
	                new Review(postRepository.findById(3L).get(), userRepository.findById(2L).get(), 4, "La reparación de tuberías fue satisfactoria, pero el costo fue un poco alto.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(7L).get(), userRepository.findById(4L).get(), 5, "Excelente trabajo en la construcción de la casa. Quedó perfecta.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(8L).get(), userRepository.findById(4L).get(), 3, "La instalación del sistema de gas fue buena, pero faltaron algunos detalles.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(9L).get(), userRepository.findById(4L).get(), 5, "El mantenimiento de áreas verdes fue muy profesional y efectivo.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(10L).get(), userRepository.findById(4L).get(), 4, "La restauración de muebles fue buena, aunque se retrasaron un poco.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(11L).get(), userRepository.findById(4L).get(), 5, "Instalación eléctrica perfecta. Muy profesional.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(15L).get(), userRepository.findById(6L).get(), 4, "La instalación de sanitarios estuvo bien.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(16L).get(), userRepository.findById(6L).get(), 5, "Muy satisfecho con la reparación del televisor. Quedó como nuevo.", dateFormat.parse("2024-01-10")),
	                new Review(postRepository.findById(4L).get(), userRepository.findById(2L).get(), 3, "El mueble quedó bien, pero se tardaron más de lo esperado en su fabricación.", dateFormat.parse("2024-01-10"))
	       );
