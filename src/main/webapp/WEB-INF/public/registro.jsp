	...
	<main class="flex min-h-screen justify-center bg-wood p-3 md:p-4">
		<section class="m-auto flex max-w-5xl flex-col items-center justify-center gap-y-6 rounded-xl bg-slate-50 px-4 py-6 dark:bg-neutral-800">
			...
			<p class="text-center text-2xl font-medium md:mx-auto md:w-3/4 dark:text-slate-50">
				Registrate <br /> ¡y conectá con los servicios en tu zona!
			</p>
			<div class="w-full items-center justify-center gap-5 rounded-xl bg-orange-800 p-4 md:flex dark:bg-transparent">
				<div class="w-full">
					...
					<form:form action="/register" method="POST" enctype="multipart/form-data" modelAttribute="newUser" class="my-2 flex flex-col gap-y-2 rounded-md bg-slate-50 px-6 py-6 dark:bg-orange-800">
						...
						<p class="mt-1 text-sm dark:text-stone-50">
							¿Ya tenés una cuenta?
							<a class="font-semibold underline" href="/iniciar-sesion">Inicia sesión</a>
						</p>
						<p class="mt-1 text-sm dark:text-stone-50">
							¿Te gustaría ofrecer tus servicios?
							<a class="font-semibold underline" href="/registro_laburante">Registrate aquí</a>
						</p>
					</form:form>
				</div>
